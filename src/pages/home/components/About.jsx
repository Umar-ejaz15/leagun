  ...
  return (
    <section className="relative  py-5 lg:px-0 overflow-hidden bg-gradient-to-b from-white to-gray-50">
      ...
      <div className="relative px-6 z-10 max-w-5xl mx-auto mb-5  text-center">
        ...
        >
          Founded by <span className="font-bold">Zain Noor</span>, our mission
          is simple: to help businesses grow sales with systems that actually
          deliver predictable, repeatable revenue.
        </motion.p>
      </div>
