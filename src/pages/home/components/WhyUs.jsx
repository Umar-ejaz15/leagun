...
import { CheckCircle, LineChart, MapPin, FileText, Link, UserCheck } from "lucide-react";
    ...
    <section className="relative w-full bg-white py-20 px-6 md:px-12">
      <div className="max-w-7xl mx-auto text-center">
        ...
        <h2 className="text-4xl sm:text-5xl font-extrabold text-gray-900 mb-6 leading-tight">
          ...
          <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600">Our SEO Agency</span>
          </Highlighter>{" "}
           for Your Service Business?
        </h2>
        <p className="text-lg text-gray-700 max-w-3xl mx-auto mb-14">
          We understand blue-collar industries. Our strategies are built to get real, local customers for your plumbing, HVAC, electrical, and contractor business. From optimizing your Google Business Profile to building authority with backlinks, we help you dominate local search.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
        {[
          ...
          <div
            key={i}
            className="bg-gray-50 hover:bg-white transition shadow-sm hover:shadow-md rounded-2xl p-6 text-left border border-gray-100"
          >
            <div className="flex items-center mb-4">
              <div className="p-3 rounded-full bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500">
                {item.icon}
              </div>
            </div>
